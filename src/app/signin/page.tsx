...
const Page = () => {
  ...
  return (
    <div className="h-[88vh] flex justify-center items-center">
      ...
      <Card className="max-w-[300px] border-0 rounded-lg">
        <CardContent className="p-6 dark:bg-gray-900 bg-gray-200 rounded-lg">
          <CardHeader className="pl-0 pt-0">
            <CardTitle className="text-lg leading-3">
              Sign in to continue
            </CardTitle>
            {/* <div className="p-6 dark:bg-gray-900 bg-gray-200 rounded-xl"> */}
